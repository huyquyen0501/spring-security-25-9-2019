...
CREATE TABLE `coursedetails` (
  ...
  PRIMARY KEY (`courseid`,`studentid`,`attend`),
  KEY `studentid` (`studentid`),
  CONSTRAINT `coursedetails_ibfk_1` FOREIGN KEY (`courseid`) REFERENCES `course` (`id`),
  CONSTRAINT `coursedetails_ibfk_2` FOREIGN KEY (`studentid`) REFERENCES `users` (`id`)
...
-- Dump completed on 2019-09-26 16:58:25
